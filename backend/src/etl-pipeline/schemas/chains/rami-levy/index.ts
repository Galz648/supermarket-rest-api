...
const normalizeCity = (cityCode: string) => {
    const city = new Map([
        // Main cities
        ['3000', 'ירושלים'],  // Multiple Jerusalem locations
        ['4000', 'חיפה'],     // Haifa locations including Check Post
        ['7900', 'פתח תקווה'],
        ['7400', 'נתניה'],
        ['9000', 'באר שבע'],
        ['6600', 'חולון'],
        ['0', 'אשקלון'],      // Ashkelon (appears with both 0 and 7100)
        ['7100', 'אשקלון'],   // Alternative code for Ashkelon
        // Other cities
        ['1139', 'כרמיאל'],
        ['2800', 'קרית שמונה'],
        ['6100', 'מרלוג'],
